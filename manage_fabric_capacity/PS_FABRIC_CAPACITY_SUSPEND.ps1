...
$suspendUrl = "https://management.azure.com/subscriptions/$subscriptionId/resourceGroups/$resourceGroupName/providers/Microsoft.Fabric/capacities/$dedicatedCapacityName/suspend?api-version=$apiVersion"
...
try {
    ...
    Write-Output "Fabric capacity suspended successfully."
} catch {
    Write-Error "Failed to suspend Fabric capacity. $_"
}
