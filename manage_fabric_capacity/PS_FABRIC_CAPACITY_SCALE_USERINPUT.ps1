...
# Step to prompt user for SKU input
$sku = Read-Host -Prompt "Enter the SKU value (e.g., F4)"
...
$capacityUrl = "https://management.azure.com/subscriptions/$subscriptionId/resourceGroups/$resourceGroupName/providers/Microsoft.Fabric/capacities/$dedicatedCapacityName/?api-version=$apiVersion"
$headers = @{
